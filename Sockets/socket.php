...
if (($sock = socket_create(AF_INET, SOCK_STREAM, 0)) === false) {
    echo "ERRO - falha na criacao do socket " . socket_strerror(socket_last_error()) . "\n";
}
...
if (socket_listen($sock) === false) {
    echo "ERRO estabelecer ligagao " . socket_strerror(socket_last_error($sock)) . " \n";
} else {
...
do {
    ...
    $msg = "\n Bem vindo à comunicação através de SOCKETS - Valério\n";
    $msg2 = "\n Primeira comunicação com TELNET – Valério! ADEUS!\n";
